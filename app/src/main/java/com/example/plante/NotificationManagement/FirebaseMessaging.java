...
import com.example.plante.NotificationManagement.AndroidNotification;
...
public class FirebaseMessaging extends FirebaseMessagingService {
	...
	private void showPostNotification(String pId, String pTitle, String pDescription) {
		...
		Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.ic_plante);
		Uri notificationSoundUri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
		NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this, "" + ADMIN_CHANNEL_ID).setSmallIcon(R.drawable.ic_plante).setLargeIcon(largeIcon).setContentTitle(pTitle).setContentText(pDescription).setSound(notificationSoundUri).setContentIntent(pendingIntent);
	...
	private void sendNormalNotification(RemoteMessage remoteMessage) {
		...
		Intent intent = new Intent(this, MessageFrame.class);
	...
	private void sendOAndAboveNotification(RemoteMessage remoteMessage) {
		...
		AndroidNotification notification1 = new AndroidNotification(this);
